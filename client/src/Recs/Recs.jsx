    ...
    <div id="recs">
      ...
      {suggestions && suggestions.length > 0 ? (
        <div className="rec_card">
          ...
          <div className="venue">
            <img
              src={`https://maps.googleapis.com/maps/api/place/photo?maxwidth=4000&photo_reference=${suggestions[0].photos[0].photo_reference}&key=AIzaSyDV9vvgvCz9W2YmXQHTcf_4lU93hCulmbU`}
              alt=""
            />
